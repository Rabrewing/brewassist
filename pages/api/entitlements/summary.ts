...
import { buildEntitlementSummary } from '@/lib/console/controlPlane';
...
export default async function handler(
  ...
  try {
    ...
    const entitlements = await buildEntitlementSummary(
      client,
      user,
    ...
    console.error('[api/entitlements/summary]', error?.message ?? error);
