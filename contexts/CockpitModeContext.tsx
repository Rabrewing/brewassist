...
const CockpitModeContext = createContext<CockpitModeContextType | undefined>(
  undefined
);

export function CockpitModeProvider({
  children,
  initialMode,
}: {
  ...
  const [mode, setMode] = useState<CockpitMode>(initialMode || 'admin'); // Default to "admin"
